...
export function PrintSection({ formData, orderNumber }: PrintSectionProps) {
  const handlePrintLabel = () => {
    const labelContent = `
      <html>
        <head>
          <title>Etiqueta - Orden ${orderNumber}</title>
          <style>
            body { 
  ...
  const handlePrintVoucher = () => {
    const totalParts = formData.parts.reduce((sum: number, part: any) => 
    ...
    const voucherContent = `
      <html>
        <head>
          <title>Voucher de Retiro - Orden ${orderNumber}</title>
          <style>
            body { 
              font-family: Arial, sans-serif; 
              padding: 30px;
        ...
        <body>
          <div class="voucher">
            <div class="header">
              ...
              <div class="order-num">ORDEN #${orderNumber}</div>
            ...
            <div class="section">
              ...
              <div class="info-row">${formData.workDetails || 'N/A'}</div>
